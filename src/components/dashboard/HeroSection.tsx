  ...
  return (
    <div className="rounded-[2rem] border border-orange-200 bg-white p-8 shadow-[0_20px_60px_rgba(15,23,42,0.08)]">
      <span className="inline-flex rounded-full bg-orange-100 px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-orange-700">
        Club Spending Overview
      </span>
      <h2 className="mt-4 text-4xl font-black tracking-tight text-slate-950">
        Track club budgets, your role, and expense requests in one place.
      </h2>
      <p className="mt-4 max-w-2xl text-base leading-7 text-slate-600">
        Review active clubs, confirm which club your wallet belongs to, and
        check request status before moving into the admin, lead, or student
        actions for approvals and submissions.
      </p>
